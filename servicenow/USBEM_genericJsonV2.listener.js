/*
 * Push connector listener: USBEM genericJsonV2
 * Deploy as the script on sn_em_connector_listener "USBEM genericJsonV2" (source genericJsonV2).
 *
 * This runs in the global scope, so it calls the scoped Script Includes by their full API name.
 * It deliberately does NOT inline copies of them: the previous build did, and the copies drifted
